 ...
 * This class leverages {@link DataSourceProperties} to configure the data source
...
public class HikariCP implements ConnectionPoolFactory {
   ...
   * specified in {@link DataSourceProperties}, this method prepares a HikariDataSource
