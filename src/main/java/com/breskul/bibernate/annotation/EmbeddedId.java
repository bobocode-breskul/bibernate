 ...
 * composite primary key that is an embeddable class. The embeddable class must be annotated as
 * {@link Embeddable}.
 *
 ...
 * with the <code>EmbeddedId</code> annotation to specify a derived primary key.
 *
 * <p> If the entity has a derived primary key, the
 * <code>AttributeOverride</code> annotation may only be used to
 * override those attributes of the embedded id that do not correspond to the relationship to the
 * parent entity.
 *
